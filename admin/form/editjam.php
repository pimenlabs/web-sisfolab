...
$sql="SELECT * FROM Jam WHERE indeks='$id'";
...
id="llastname" for="lastname">Jam Matakuliah<span class="req">*</span></label>
<div class="form_input"> <input id="kode" name="Jam"
value="<?php echo $rows['Jam']; ?>" maxlength="100"class="limiter required" type="text"> </div>
</div>
</li>
...
$query = mysql_query("UPDATE Jam SET Jam='$Kode' WHERE indeks='$id'");
			if($query){
				echo "<br>";
